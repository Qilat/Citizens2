...
import fr.poudlardrp.citizens.api.command.exception.ServerCommandException;
import fr.poudlardrp.citizens.api.event.CommandSenderCreateNPCEvent;
...
import fr.poudlardrp.citizens.trait.SkinLayers.Layer;
...
public class NPCCommands {
    ...
    public void playerlist(CommandContext args, CommandSender sender, NPC npc) {
        boolean remove = !npc.data().get("removefromplayerlist", Settings.Setting.REMOVE_PLAYERS_FROM_PLAYER_LIST.asBoolean());
        if (args.hasFlag('a')) {
            remove = false;
    ...
    public void speed(CommandContext args, CommandSender sender, NPC npc) throws CommandException {
        ...
        if (newSpeed >= Settings.Setting.MAX_SPEED.asDouble())
