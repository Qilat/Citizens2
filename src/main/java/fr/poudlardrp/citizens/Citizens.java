...
import fr.poudlardrp.citizens.npc.ai.speech.Chat;
import fr.poudlardrp.citizens.npc.ai.speech.CitizensSpeechFactory;
...
public class Citizens extends JavaPlugin implements CitizensPlugin {
    ...
    private NPCDataStore createStorage(File folder) {
        ...
        if (type.equalsIgnoreCase("nbt")) {
            saves = new NBTStorage(new File(folder + File.separator + Settings.Setting.STORAGE_FILE.asString()),
    ...
    private void enableSubPlugins() {
        File root = new File(getDataFolder(), Settings.Setting.SUBPLUGIN_FOLDER.asString());
    ...
    public void onEnable() {
        ...
        if (getServer().getScheduler().scheduleSyncDelayedTask(this, new Runnable() {
            ...
            public void run() {
                ...
                startMetrics();
                scheduleSaveTask(Settings.Setting.SAVE_TASK_DELAY.asInt());
