...
public interface CompileCallback {
     ...
     *
     * @param sourceDescriptor A source description: may be a file name or a unique identifier assigned to a source string, or null.
     * @param compiled         The compiled source code
     */
