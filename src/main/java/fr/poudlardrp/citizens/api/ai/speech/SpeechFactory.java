...
public interface SpeechFactory {
     ...
     *
     * @param name The class of the desired VocalChord
     ...
     *
     * @param name The name of the desired VocalChord
     ...
     *
     * @param clazz The VocalChord class
     ...
     *
     * @param name The name of the VocalChord to check
     ...
     *
     * @param livingEntity the livingEntity to use
     ...
     *
     * @param clazz The VocalChord class
     * @param name  The name of the VocalChord
     */
